...
int main(){
    ...
    for (int kk=1;kase--;++kk){
        ...
        for (int i=0;i<n;++i){
            ...
            if ( mp.find( make_pair( make_pair( num,den ), make_pair( xx,yy ) ) ) == mp.end() ){
                mp[ make_pair( make_pair( num,den ), make_pair( xx,yy ) ) ] = cnt++;
            }

            ans[  mp[ make_pair( make_pair( num,den ), make_pair( xx,yy ) ) ] ] .PB( tmp );
        }
